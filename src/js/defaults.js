...
export const defaultKeyColorMap = {
    orderId: {
        fgColor: colorsMap.fgBlack,
        bgColor: colorsMap.bgBrightMagenta,
    },
    sessionId: {
        fgColor: colorsMap.fgBlack,
        bgColor: colorsMap.bgCyan,
    },
    processId: {
        fgColor: colorsMap.fgBlack,
        bgColor: colorsMap.bgBrightGreen,
    },
    functionName: {
        fgColor: colorsMap.fgBlack,
        bgColor: colorsMap.bgBrightRed,
    },
    type: {
        fgColor: colorsMap.fgBlack,
        bgColor: colorsMap.bgGreen,
    },
    body: {
        fgColor: "",
        bgColor: "",
